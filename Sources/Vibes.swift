...
public class Vibes: EventTracker {
    ...
    public static let SDK_VERSION = "1.0.2"
    ...
    public func handleWalletPass(notification: [String: Any], completion: @escaping ((PKAddPassesViewController?) -> ())) {
        if let walletPkPass = notification["wallet"] as? String {
            print("Receive a coupon! \(walletPkPass)")
